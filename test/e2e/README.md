...
- [`http.go`](utils/http.go) — Gateway access (`GetGatewayURLFor`): DNS-independent, hostname-preserving Service tunnels on Azure, multi-gateway port-forwarding upstream, and `SendChatCompletion`.
