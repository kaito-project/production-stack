...
| `bbr.image.{registry,repository,tag,pullPolicy}` | `mcr.microsoft.com/oss/v2/gateway-api-inference-extension/bbr:v1.5.0`        | Container image coordinates for the released BBR image mirrored in MCR. |
