...
| `gatewayName`                             | `<namespace>-gw`                 | Per-namespace Gateway name. The controller-generated Service is discovered by its standard Gateway label.                                                                                                |
| `gatewayClassName`                        | `istio`                          | `GatewayClass` the Gateway binds to (AKS Istio add-on with App Routing: `approuting-istio`).                                                                                                               |
| `gatewayPort`                             | `80`                             | HTTP listener port on the Gateway. Azure additionally scopes the listener to the AKS default-domain hostname.                                                                                             |
